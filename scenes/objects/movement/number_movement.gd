...
var connected_paths : Array[Path] = []
var input_paths : Array[Path] = []
var output_paths : Array[Path] = []
...
func get_connected_paths() -> Array[Path]:
	return connected_paths

func get_input_paths() -> Array[Path]:
	return input_paths

func get_output_paths() -> Array[Path]:
	return output_paths
